...
func (z *Element) BytesLE() (res [Limbs * 8]byte) {
	_z := z.ToRegular()
	binary.LittleEndian.PutUint64(res[24:32], _z[0])
	binary.LittleEndian.PutUint64(res[16:24], _z[1])
	binary.LittleEndian.PutUint64(res[8:16], _z[2])
	binary.LittleEndian.PutUint64(res[0:8], _z[3])
