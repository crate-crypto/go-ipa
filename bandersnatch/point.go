...
// This file has been editted to fix bugs. In partcular, Bytes, ScalarMul, PointAddition(Proj)
...
// scal scalar in Montgomery form
// modifies p
func (p *PointAffine) ScalarMul(p1 *PointAffine, scalar fp.Element) *PointAffine {
